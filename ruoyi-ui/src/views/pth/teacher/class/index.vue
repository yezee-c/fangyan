  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="classList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="邀请码" align="center" prop="invitationCode" width="120">
        <template slot-scope="scope">
          <el-tag type="success">{{ scope.row.invitationCode }}</el-tag>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="学期" prop="semester">
          <el-input v-model="form.semester" placeholder="请输入学期，如：2024-2025第一学期" />
        </el-form-item>
        <el-form-item label="邀请码" prop="invitationCode">
          <el-input v-model="form.invitationCode" placeholder="留空自动生成" disabled>
            <el-button slot="append" icon="el-icon-refresh" @click="handleGenerateCode">生成</el-button>
          </el-input>
        </el-form-item>
...
<script>
import { listMyClass, getClass, delClass, addClass, updateClass, generateCode } from "@/api/pth/class";
  ...
  methods: {
    ...
    handleGenerateCode() {
      generateCode().then(response => {
        this.form.invitationCode = response.data;
      });
    }
  }
};
